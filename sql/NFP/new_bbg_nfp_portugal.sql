...
-- 2025/10/11 Etemenanki science need any improvement
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_TILE_IS_FARM_GRASS_FLOODPLAIN_REQSET', 'BBG_TILE_HAS_ANY_IMPROVEMENT'),
    ('BBG_TILE_IS_FARM_PLAINS_FLOODPLAIN_REQSET', 'REQUIRES_PLOT_HAS_PLAINS_FLOODPLAINS'),
    ('BBG_TILE_IS_FARM_PLAINS_FLOODPLAIN_REQSET', 'BBG_TILE_HAS_ANY_IMPROVEMENT'),
    ('BBG_TILE_IS_FARM_DESERT_FLOODPLAIN_REQSET', 'REQUIRES_PLOT_HAS_FLOODPLAINS'),
    ('BBG_TILE_IS_FARM_DESERT_FLOODPLAIN_REQSET', 'BBG_TILE_HAS_ANY_IMPROVEMENT');
...
-- 2026/06/30 Cost increased to 300 from 200
UPDATE Buildings SET Cost=600, PrereqCivic='CIVIC_EXPLORATION' WHERE BuildingType='BUILDING_TORRE_DE_BELEM';
