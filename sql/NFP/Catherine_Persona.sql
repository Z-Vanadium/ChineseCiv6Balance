...
-- 2026/03/15 back
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_MAGNIFICENCES', 'CCB_IMPROVED_RESOURCE_CULTURE_NEXT_CHATEAU');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_IMPROVED_RESOURCE_CULTURE_NEXT_CHATEAU', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, NULL, 'REQSET_CCB_PLOT_IMPROVED_RESOURCE_NEXT_CHATEAU');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_IMPROVED_RESOURCE_CULTURE_NEXT_CHATEAU', 'Amount', '1'), 
('CCB_IMPROVED_RESOURCE_CULTURE_NEXT_CHATEAU', 'YieldType', 'YIELD_CULTURE');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_PLOT_IMPROVED_RESOURCE_NEXT_CHATEAU', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_PLOT_IMPROVED_RESOURCE_NEXT_CHATEAU', 'REQ_CCB_PLOT_HAS_ANY_IMPROVEMENT'), 
('REQSET_CCB_PLOT_IMPROVED_RESOURCE_NEXT_CHATEAU', 'REQ_CCB_PLOT_HAS_ANY_RESOURCE'), 
('REQSET_CCB_PLOT_IMPROVED_RESOURCE_NEXT_CHATEAU', 'REQ_CCB_PLOT_NEXT_CHATEAU');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_PLOT_HAS_ANY_IMPROVEMENT', 'REQUIREMENT_PLOT_HAS_ANY_IMPROVEMENT'), 
('REQ_CCB_PLOT_HAS_ANY_RESOURCE', 'REQUIREMENT_PLOT_HAS_ANY_RESOURCE'), 
('REQ_CCB_PLOT_NEXT_CHATEAU', 'REQUIREMENT_PLOT_ADJACENT_IMPROVEMENT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_PLOT_NEXT_CHATEAU', 'ImprovementType', 'IMPROVEMENT_CHATEAU'), 
('REQ_CCB_PLOT_NEXT_CHATEAU', 'MaxRange', '1'), 
('REQ_CCB_PLOT_NEXT_CHATEAU', 'MinRange', '0');

-- Luxury next to chateau grant 1 amenity
-- 2025/10/11 Lux no longer grant 1 amenity
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
