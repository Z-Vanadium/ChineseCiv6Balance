...
UPDATE Civics SET Description='LOC_CIVIC_SUFFRAGE_DESCRIPTION' WHERE CivicType='CIVIC_SUFFRAGE';
UPDATE Civics SET Description='LOC_CIVIC_TOTALITARIANISM_DESCRIPTION' WHERE CivicType='CIVIC_TOTALITARIANISM';
UPDATE Civics SET Description='LOC_CIVIC_CLASS_STRUGGLE_DESCRIPTION' WHERE CivicType='CIVIC_CLASS_STRUGGLE';
UPDATE Civics SET Description='LOC_CIVIC_CORPORATE_LIBERTARIANISM_DESCRIPTION' WHERE CivicType='CIVIC_CORPORATE_LIBERTARIANISM';
UPDATE Civics SET Description='LOC_CIVIC_DIGITAL_DEMOCRACY_DESCRIPTION' WHERE CivicType='CIVIC_DIGITAL_DEMOCRACY';
UPDATE Civics SET Description='LOC_CIVIC_SYNTHETIC_TECHNOCRACY_DESCRIPTION' WHERE CivicType='CIVIC_SYNTHETIC_TECHNOCRACY';