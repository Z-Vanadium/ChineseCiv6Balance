...
-- 2026/03/15: WB culture and faith removed, now +1/+1 limited for camp and sea resource with foreign trade
-- 2026/06/30: 重商主义后+1信仰值+1文化值
...
DELETE FROM Improvement_Adjacencies WHERE ImprovementType='IMPROVEMENT_LIME_THULE_WBH' AND YieldChangeId IN ('Lime_WBH_Faith', 'Lime_WBH_Culture');

INSERT INTO ImprovementModifiers (ImprovementType, ModifierId) VALUES 
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_CULTURE_LATE'),
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_FAITH_LATE');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_CULTURE_LATE', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_MERCANTILISM_REQSET', NULL),
('CCB_THULE_UI_FAITH_LATE', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_MERCANTILISM_REQSET', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_CULTURE_LATE', 'Amount', '1'), 
('CCB_THULE_UI_CULTURE_LATE', 'YieldType', 'YIELD_CULTURE'),
('CCB_THULE_UI_FAITH_LATE', 'Amount', '1'), 
('CCB_THULE_UI_FAITH_LATE', 'YieldType', 'YIELD_FAITH');

INSERT INTO ImprovementModifiers (ImprovementType, ModifierId) VALUES 
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_CULTURE_FROM_CAMP');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_CAMP');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'Amount', '1'), 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'YieldType', 'YIELD_CULTURE');

INSERT INTO ImprovementModifiers (ImprovementType, ModifierId) VALUES 
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_FAITH_FROM_CAMP');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_CAMP');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'Amount', '1'), 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'YieldType', 'YIELD_FAITH');

INSERT INTO ImprovementModifiers (ImprovementType, ModifierId) VALUES 
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_FISHING_BOATS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'Amount', '1'), 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'YieldType', 'YIELD_CULTURE');

INSERT INTO ImprovementModifiers (ImprovementType, ModifierId) VALUES 
('IMPROVEMENT_LIME_THULE_WBH', 'CCB_THULE_UI_FAITH_FROM_FISHING_BOATS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_FAITH_FROM_FISHING_BOATS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_FISHING_BOATS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_FAITH_FROM_FISHING_BOATS', 'Amount', '1'), 
('CCB_THULE_UI_FAITH_FROM_FISHING_BOATS', 'YieldType', 'YIELD_FAITH');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_THULE_UI_CAMP', 'REQUIREMENTSET_TEST_ALL'),
('REQSET_CCB_THULE_UI_FISHING_BOATS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_THULE_UI_CAMP', 'REQ_CCB_PLOT_HAS_THULE_UI'), 
('REQSET_CCB_THULE_UI_CAMP', 'REQ_CCB_PLOT_NEXT_CAMP'),
('REQSET_CCB_THULE_UI_FISHING_BOATS', 'REQ_CCB_PLOT_HAS_THULE_UI'), 
('REQSET_CCB_THULE_UI_FISHING_BOATS', 'REQ_CCB_PLOT_NEXT_FISHING_BOATS');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_PLOT_HAS_THULE_UI', 'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES'), 
('REQ_CCB_PLOT_NEXT_CAMP', 'REQUIREMENT_PLOT_ADJACENT_IMPROVEMENT_TYPE_MATCHES'),
('REQ_CCB_PLOT_NEXT_FISHING_BOATS', 'REQUIREMENT_PLOT_ADJACENT_IMPROVEMENT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_PLOT_HAS_THULE_UI', 'ImprovementType', 'IMPROVEMENT_LIME_THULE_WBH'), 
('REQ_CCB_PLOT_NEXT_CAMP', 'ImprovementType', 'IMPROVEMENT_CAMP'), 
('REQ_CCB_PLOT_NEXT_CAMP', 'MaxRange', '1'), 
('REQ_CCB_PLOT_NEXT_CAMP', 'MinRange', '0'),
('REQ_CCB_PLOT_NEXT_FISHING_BOATS', 'ImprovementType', 'IMPROVEMENT_FISHING_BOATS'), 
('REQ_CCB_PLOT_NEXT_FISHING_BOATS', 'MaxRange', '1'), 
('REQ_CCB_PLOT_NEXT_FISHING_BOATS', 'MinRange', '0');

-- 2025/10/24: camp culture and faith from WB House now requires Foreign Trade
...
-- 2025/10/24: fishing boats culture and faith from WB House now requires Foreign Trade
