...
-- Thule's palace get a whalemaker with astrology and cartography
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_WM_GIVER_ASTROLOGY'),
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_WM_GIVER_CARTOGRAPHY');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_WM_GIVER_ASTROLOGY', 'MODIFIER_PLAYER_GRANT_UNIT_IN_CAPITAL', 1, 1, 0, 'BBG_UTILS_PLAYER_HAS_TECH_ASTROLOGY', 'PLAYER_HAS_AT_LEAST_ONE_CITY_REQUIREMENTS');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_WM_GIVER_ASTROLOGY', 'AllowUniqueOverride', '1'), 
('CCB_THULE_WM_GIVER_ASTROLOGY', 'Amount', '1'), 
('CCB_THULE_WM_GIVER_ASTROLOGY', 'UnitType', 'UNIT_CCB_THULE_WHALEMAKER');
...
INSERT INTO Types (Type, Kind) VALUES ('TRAIT_CCB_THULE_EMPTY', 'KIND_TRAIT');

INSERT INTO Traits (TraitType, Name, Description)
VALUES	('TRAIT_CCB_THULE_EMPTY', 'LOC_TRAIT_CCB_THULE_EMPTY_NAME', 'LOC_TRAIT_CCB_THULE_EMPTY_DESCRIPTION');

-- UPDATE Units SET CanTrain=1, Cost=1000, CostProgressionParam1=1000 WHERE UnitType = 'UNIT_CCB_THULE_WHALEMAKER';
UPDATE Units SET TraitType='TRAIT_CCB_THULE_EMPTY', CanTrain=1 WHERE UnitType = 'UNIT_CCB_THULE_WHALEMAKER';
