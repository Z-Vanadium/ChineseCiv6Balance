...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_UI_CULTURE_FROM_CAMP');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_CAMP');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'Amount', '1'), 
('CCB_THULE_UI_CULTURE_FROM_CAMP', 'YieldType', 'YIELD_CULTURE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_UI_FAITH_FROM_CAMP');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_CAMP');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'Amount', '1'), 
('CCB_THULE_UI_FAITH_FROM_CAMP', 'YieldType', 'YIELD_FAITH');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_FISHING_BOATS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'Amount', '1'), 
('CCB_THULE_UI_CULTURE_FROM_FISHING_BOATS', 'YieldType', 'YIELD_CULTURE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_LIME_THULE_HUNTING_BOWHEAD', 'CCB_THULE_UI_FAITH_FROM_FISHING_BOATS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_THULE_UI_FAITH_FROM_FISHING_BOATS', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_FOREIGN_TRADE_REQSET', 'REQSET_CCB_THULE_UI_FISHING_BOATS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
