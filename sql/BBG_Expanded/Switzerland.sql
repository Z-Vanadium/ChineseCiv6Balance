...
-- 2026/07/12 UU 享受阿卡德和攻城塔、破城锤效果
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
('MINOR_CIV_AKKAD_UNIQUE_INFLUENCE_BONUS_CVS_SWITZERLAND_UU_CCB', 'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER', 'PLAYER_IS_SUZERAIN'),
('MINOR_CIV_AKKAD_ENABLE_WALL_ATTACK_WHOLE_GAME_CVS_SWITZERLAND_UU_CCB', 'MODIFIER_PLAYER_UNITS_ADJUST_ENABLE_WALL_ATTACK_WHOLE_GAME_PROMOTION_CLASS', NULL);
INSERT INTO ModifierArguments(ModifierId, Name , Value) VALUES
('MINOR_CIV_AKKAD_ENABLE_WALL_ATTACK_WHOLE_GAME_CVS_SWITZERLAND_UU_CCB', 'PromotionClass', 'PROMOTION_CLASS_CVS_SWITZERLAND_UU'),
('MINOR_CIV_AKKAD_UNIQUE_INFLUENCE_BONUS_CVS_SWITZERLAND_UU_CCB', 'ModifierId', 'MINOR_CIV_AKKAD_ENABLE_WALL_ATTACK_WHOLE_GAME_CVS_SWITZERLAND_UU_CCB');
INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
('MINOR_CIV_AKKAD_TRAIT', 'MINOR_CIV_AKKAD_UNIQUE_INFLUENCE_BONUS_CVS_SWITZERLAND_UU_CCB');

INSERT INTO Modifiers(ModifierId, ModifierType) VALUES
    ('CCB_ENABLE_WALL_ATTACK_CVS_SWITZERLAND_UU', 'MODIFIER_PLAYER_UNIT_ADJUST_ENABLE_WALL_ATTACK_PROMOTION_CLASS'),
    ('CCB_BYPASS_WALLS_CVS_SWITZERLAND_UU','MODIFIER_PLAYER_UNIT_ADJUST_BYPASS_WALLS_PROMOTION_CLASS');

INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('CCB_ENABLE_WALL_ATTACK_CVS_SWITZERLAND_UU', 'PromotionClass', 'PROMOTION_CLASS_CVS_SWITZERLAND_UU'),
    ('CCB_BYPASS_WALLS_CVS_SWITZERLAND_UU', 'PromotionClass', 'PROMOTION_CLASS_CVS_SWITZERLAND_UU');
...
INSERT INTO UnitAbilityModifiers(UnitAbilityType, ModifierId) VALUES
    ('ABILITY_ENABLE_WALL_ATTACK_PROMOTION_CLASS','CCB_ENABLE_WALL_ATTACK_CVS_SWITZERLAND_UU'),
    ('ABILITY_BYPASS_WALLS_PROMOTION_CLASS','CCB_BYPASS_WALLS_CVS_SWITZERLAND_UU');
