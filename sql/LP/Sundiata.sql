...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_SUNDIATA_GREAT_WRITER_POINT_GIVER', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_CITY_HAS_SUGUBA_THEATER_REQSET'),
    ('BBG_SUNDIATA_GREAT_WRITER_POINT', 'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS', 'BBG_DISTRICT_IS_DISTRICT_CITY_CENTER_REQSET');
