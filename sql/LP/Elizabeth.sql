...
INSERT INTO Types (Type, Kind) VALUES
    ('BBG_MODIFIER_UNIT_UNIT_PROMOTE_NO_FINISH_MOVES', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
    ('BBG_MODIFIER_UNIT_UNIT_PROMOTE_NO_FINISH_MOVES', 'COLLECTION_OWNER', 'EFFECT_ADJUST_UNIT_PROMOTE_NO_FINISH_MOVES');
INSERT INTO Types (Type, Kind) VALUES
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_ABILITY_ELISABETH_RAIDER_MOVE_PROMOTE_ATTACK_GIVER', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', NULL),
    ('BBG_ABILITY_ELISABETH_RAIDER_MOVE_PROMOTE_ATTACK_MODIFIER', 'BBG_MODIFIER_UNIT_UNIT_PROMOTE_NO_FINISH_MOVES', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
-- 2026/07/12 新增海狗获得抓船能力
UPDATE Modifiers SET OwnerRequirementSetId='BBG_PLAYER_IS_LEADER_ELIZABETH_REQSET' WHERE ModifierId='CAPTURE_PRIZE_SHIPS';