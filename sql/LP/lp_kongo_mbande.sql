...
-- commercial and theatre districts get +1 from forest and jungle in city with ud
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_NZINGA_MBANDE', 'CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST'),
('TRAIT_LEADER_NZINGA_MBANDE', 'CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE'),
('TRAIT_LEADER_NZINGA_MBANDE', 'CCB_KONGO_THEATRE_ADJACENCY_FOREST'),
('TRAIT_LEADER_NZINGA_MBANDE', 'CCB_KONGO_THEATRE_ADJACENCY_JUNGLE');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'MODIFIER_PLAYER_CITIES_FEATURE_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'MODIFIER_PLAYER_CITIES_FEATURE_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'MODIFIER_PLAYER_CITIES_FEATURE_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'MODIFIER_PLAYER_CITIES_FEATURE_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'Amount', '1'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'Description', 'LOC_CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST_DESCRIPTION'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'DistrictType', 'DISTRICT_COMMERCIAL_HUB'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'FeatureType', 'FEATURE_FOREST'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'TilesRequired', '2'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'YieldType', 'YIELD_GOLD'),

('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'Amount', '1'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'Description', 'LOC_CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE_DESCRIPTION'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'DistrictType', 'DISTRICT_COMMERCIAL_HUB'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'FeatureType', 'FEATURE_JUNGLE'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'TilesRequired', '2'), 
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'YieldType', 'YIELD_GOLD'),

('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'Amount', '1'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'Description', 'LOC_CCB_KONGO_THEATRE_ADJACENCY_FOREST_DESCRIPTION'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'DistrictType', 'DISTRICT_THEATER'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'FeatureType', 'FEATURE_FOREST'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'TilesRequired', '2'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'YieldType', 'YIELD_CULTURE'),

('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'Amount', '1'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'Description', 'LOC_CCB_KONGO_THEATRE_ADJACENCY_JUNGLE_DESCRIPTION'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'DistrictType', 'DISTRICT_THEATER'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'FeatureType', 'FEATURE_JUNGLE'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'TilesRequired', '2'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'YieldType', 'YIELD_CULTURE');