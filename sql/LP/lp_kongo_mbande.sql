...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_KONGO_COMMERCIAL_ADJACENCY_FOREST', 'MODIFIER_PLAYER_CITIES_DISTRICT_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_COMMERCIAL_ADJACENCY_JUNGLE', 'MODIFIER_PLAYER_CITIES_DISTRICT_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'MODIFIER_PLAYER_CITIES_DISTRICT_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA'),
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'MODIFIER_PLAYER_CITIES_DISTRICT_ADJACENCY', 0, 0, 0, NULL, 'BBG_CITY_HAS_MBANZA');
...
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'DistrictType', 'DISTRICT_THEATRE'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'FeatureType', 'FEATURE_FOREST'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'TilesRequired', '1'), 
('CCB_KONGO_THEATRE_ADJACENCY_FOREST', 'YieldType', 'YIELD_GOLD');
...
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'DistrictType', 'DISTRICT_THEATRE'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'FeatureType', 'FEATURE_JUNGLE'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'TilesRequired', '1'), 
('CCB_KONGO_THEATRE_ADJACENCY_JUNGLE', 'YieldType', 'YIELD_GOLD');