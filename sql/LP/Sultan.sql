...
-- 2026/02/27 no encampment building purchase
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
...
INSERT INTO TypeTags (Type, Tag) VALUES
    ...
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_MELEE'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_ANTI_CAVALRY'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_RANGED'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_SIEGE'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_HEAVY_CAVALRY'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_LIGHT_CAVALRY'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_RANGED_CAVALRY'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_RECON'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_WARRIOR_MONK'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_LAHORE_NIHANG'),
    ('BBG_SULTAN_COMBAT_ADJACENT_APOSTLE_ABILITY', 'CLASS_GIANT_DEATH_ROBOT');
