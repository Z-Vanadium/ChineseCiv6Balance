...
-- 2026/02/26 +1 gold per tier HS building
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('MINOR_CIV_JERUSALEM_TRAIT', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_1');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_1', 'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER', 0, 0, 0, NULL, 'PLAYER_IS_SUZERAIN');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_1', 'ModifierId', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_1');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_1', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE', 0, 0, 0, NULL, 'CCB_REQSET_CITY_HAS_HS_T1_BUILDING');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_1', 'Amount', '1'), 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_1', 'YieldType', 'YIELD_GOLD');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('CCB_REQSET_CITY_HAS_HS_T1_BUILDING', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('CCB_REQSET_CITY_HAS_HS_T1_BUILDING', 'CCB_REQ_CITY_HAS_HS_T1_BUILDING');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('CCB_REQ_CITY_HAS_HS_T1_BUILDING', 'REQUIREMENT_CITY_HAS_BUILDING');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('CCB_REQ_CITY_HAS_HS_T1_BUILDING', 'BuildingType', 'BUILDING_SHRINE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('MINOR_CIV_JERUSALEM_TRAIT', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_2');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_2', 'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER', 0, 0, 0, NULL, 'PLAYER_IS_SUZERAIN');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_2', 'ModifierId', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_2');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_2', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE', 0, 0, 0, NULL, 'CCB_REQSET_CITY_HAS_HS_T2_BUILDING');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_2', 'Amount', '1'), 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_2', 'YieldType', 'YIELD_GOLD');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('CCB_REQSET_CITY_HAS_HS_T2_BUILDING', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('CCB_REQSET_CITY_HAS_HS_T2_BUILDING', 'CCB_REQ_CITY_HAS_HS_T2_BUILDING');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('CCB_REQ_CITY_HAS_HS_T2_BUILDING', 'REQUIREMENT_CITY_HAS_BUILDING');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('CCB_REQ_CITY_HAS_HS_T2_BUILDING', 'BuildingType', 'BUILDING_TEMPLE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('MINOR_CIV_JERUSALEM_TRAIT', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_3');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_3', 'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER', 0, 0, 0, NULL, 'PLAYER_IS_SUZERAIN');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_GIVER_3', 'ModifierId', 'CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_3');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_3', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE', 0, 0, 0, NULL, 'CCB_REQSET_CITY_HAS_HS_T3_BUILDING');   -- defined in Russia.sql
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_3', 'Amount', '1'), 
('CCB_MINOR_CIV_JERUSALEM_UNIQUE_INFLUENCE_BONUS_GOLD_HS_3', 'YieldType', 'YIELD_GOLD');
...
-- 2026/06/02 tananarivo: limit 20%
