...
-- +5 combat strength to jet fighter when attack cavalry
INSERT INTO Types (Type, Kind) VALUES
	('ABILITY_CCB_JETFIGHTER_VS_CAVALRY', 'KIND_ABILITY');
INSERT INTO Tags (Tag, Vocabulary) VALUES
	('CLASS_JET_FIGHTER', 'ABILITY_CLASS');
INSERT INTO TypeTags (Type, Tag) VALUES
	('ABILITY_CCB_JETFIGHTER_VS_CAVALRY', 'CLASS_JET_FIGHTER')，
	('UNIT_JET_FIGHTER', 'CLASS_JET_FIGHTER');
INSERT INTO UnitAbilities (UnitAbilityType, Name, Description) VALUES
	('ABILITY_CCB_JETFIGHTER_VS_CAVALRY', 'LOC_ABILITY_CCB_JETFIGHTER_VS_CAVALRY_NAME', 'LOC_ABILITY_CCB_JETFIGHTER_VS_CAVALRY_DESC');
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_CCB_JETFIGHTER_VS_CAVALRY', 'CCB_JETFIGHTER_VS_CAVALRY_MODIFIER');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('CCB_JETFIGHTER_VS_CAVALRY_MODIFIER', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 'ANTI_CAVALRY_OPPONENT_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('CCB_JETFIGHTER_VS_CAVALRY_MODIFIER', 'Amount', 5);
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
	('CCB_JETFIGHTER_VS_CAVALRY_MODIFIER', 'Preview', 'LOC_ABILITY_CCB_JETFIGHTER_VS_CAVALRY_DESC');

-- +7 combat strength to jet bomber when attack cavalry
INSERT INTO Types (Type, Kind) VALUES
	('ABILITY_CCB_JETBOMBER_VS_CAVALRY', 'KIND_ABILITY');
INSERT INTO Tags (Tag, Vocabulary) VALUES
	('CLASS_JET_BOMBER', 'ABILITY_CLASS');
INSERT INTO TypeTags (Type, Tag) VALUES
	('ABILITY_CCB_JETBOMBER_VS_CAVALRY', 'CLASS_JET_BOMBER'),
	('UNIT_JET_BOMBER', 'CLASS_JET_BOMBER');
INSERT INTO UnitAbilities (UnitAbilityType, Name, Description) VALUES
	('ABILITY_CCB_JETBOMBER_VS_CAVALRY', 'LOC_ABILITY_CCB_JETBOMBER_VS_CAVALRY_NAME', 'LOC_ABILITY_CCB_JETBOMBER_VS_CAVALRY_DESC');
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_CCB_JETBOMBER_VS_CAVALRY', 'CCB_JETBOMBER_VS_CAVALRY_MODIFIER');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('CCB_JETBOMBER_VS_CAVALRY_MODIFIER', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 'ANTI_CAVALRY_OPPONENT_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('CCB_JETBOMBER_VS_CAVALRY_MODIFIER', 'Amount', 7);
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
