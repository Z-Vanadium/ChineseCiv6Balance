...
-- 2026/07/05 移民2速、上下船不消耗移动力和额外视野需要造船术
UPDATE TraitModifiers SET TraitType='TRAIT_LEADER_FOUNDER_CARTHAGE' WHERE ModifierId='TRAIT_MEDITERRANEAN_COLONIES_GRANT_SETTLERS_ABILITY';
UPDATE Modifiers SET OwnerRequirementSetId='BBG_UTILS_PLAYER_HAS_TECH_SHIPBUILDING' WHERE ModifierId='TRAIT_MEDITERRANEAN_COLONIES_GRANT_SETTLERS_ABILITY';