...
-- 2026/02/26 Thermos: cost increased to 850 (from 750)
...
-- 2026/07/02 首个宇航中心奖励：全国城市增加8%科技与产能。
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_MAJOR_CIV', 'CCB_DISTRICT_SPACEPORT_PRODUCTION_BONUS'),
('TRAIT_LEADER_MAJOR_CIV', 'CCB_DISTRICT_SPACEPORT_SCIENCE_BONUS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_DISTRICT_SPACEPORT_PRODUCTION_BONUS', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 0, 0, 0, NULL, 'REQSET_CCB_PLAYER_HAS_DISTRICT_SPACEPORT'),
('CCB_DISTRICT_SPACEPORT_SCIENCE_BONUS', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 0, 0, 0, 'REQSET_CCB_PLAYER_HAS_DISTRICT_SPACEPORT', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_DISTRICT_SPACEPORT_PRODUCTION_BONUS', 'Amount', '8'), 
('CCB_DISTRICT_SPACEPORT_PRODUCTION_BONUS', 'YieldType', 'YIELD_PRODUCTION'),
('CCB_DISTRICT_SPACEPORT_SCIENCE_BONUS', 'Amount', '8'), 
('CCB_DISTRICT_SPACEPORT_SCIENCE_BONUS', 'YieldType', 'YIELD_SCIENCE');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_PLAYER_HAS_DISTRICT_SPACEPORT', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_PLAYER_HAS_DISTRICT_SPACEPORT', 'REQ_CCB_PLAYER_HAS_DISTRICT_SPACEPORT');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_PLAYER_HAS_DISTRICT_SPACEPORT', 'REQUIREMENT_PLAYER_HAS_DISTRICT');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_PLAYER_HAS_DISTRICT_SPACEPORT', 'DistrictType', 'DISTRICT_SPACEPORT');
