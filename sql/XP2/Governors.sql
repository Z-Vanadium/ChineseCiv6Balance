...
-- 19/06/25 Fishery work with Shipyard
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_SHIPYARD_FISHERY_PRODUCTION', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_TILE_IS_FISHERY_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_SHIPYARD_FISHERY_PRODUCTION', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_SHIPYARD_FISHERY_PRODUCTION', 'Amount', '1');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ('BBG_TILE_IS_FISHERY_REQUIREMENT', 'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
    ('BBG_TILE_IS_FISHERY_REQUIREMENT', 'ImprovementType', 'IMPROVEMENT_FISHERY');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_IS_FISHERY_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_IS_FISHERY_REQSET', 'BBG_TILE_IS_FISHERY_REQUIREMENT');
INSERT INTO BuildingModifiers (BuildingType, ModifierId) VALUES
    ('BUILDING_SHIPYARD', 'BBG_SHIPYARD_FISHERY_PRODUCTION');