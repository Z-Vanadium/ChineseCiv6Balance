...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_KRISTINA_WRITERS_GIVER', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_CITY_HAS_T1_BUILDING'),
    ('BBG_KRISTINA_WRITERS', 'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS', 'BBG_DISTRICT_IS_DISTRICT_CITY_CENTER_REQSET'),
    ('BBG_KRISTINA_ARTISTS_GIVER', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_CITY_HAS_T2_BUILDING'),
    ('BBG_KRISTINA_ARTISTS', 'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS', 'BBG_DISTRICT_IS_DISTRICT_CITY_CENTER_REQSET'), 
    ('BBG_KRISTINA_MUSICIANS_GIVER', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_CITY_HAS_T3_BUILDING'),
    ('BBG_KRISTINA_MUSICIANS', 'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS', 'BBG_DISTRICT_IS_DISTRICT_CITY_CENTER_REQSET');  
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
