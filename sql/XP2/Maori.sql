...
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
    ('BBG_PLOT_HAS_FOREST_EARLY_EMPIRE', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQUIREMENT'),
    ...
    ('BBG_PLOT_HAS_JUNGLE_EARLY_EMPIRE', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQUIREMENT'),
...
('TRAIT_CIVILIZATION_MAORI_MANA', 'CCB_MAORI_PRODUCTION_RAINFOREST_COLD_WAR'),
('TRAIT_CIVILIZATION_MAORI_MANA', 'CCB_MAORI_PRODUCTION_WOODS_COLD_WAR');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MAORI_PRODUCTION_RAINFOREST_COLD_WAR', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, NULL, 'REQSET_CCB_PLOT_HAS_JUNGLE_COLD_WAR'),
('CCB_MAORI_PRODUCTION_WOODS_COLD_WAR', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, NULL, 'REQSET_CCB_PLOT_HAS_FOREST_COLD_WAR');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MAORI_PRODUCTION_RAINFOREST_COLD_WAR', 'Amount', '1'), 
('CCB_MAORI_PRODUCTION_RAINFOREST_COLD_WAR', 'YieldType', 'YIELD_PRODUCTION'), 
('CCB_MAORI_PRODUCTION_WOODS_COLD_WAR', 'Amount', '1'), 
('CCB_MAORI_PRODUCTION_WOODS_COLD_WAR', 'YieldType', 'YIELD_PRODUCTION');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_PLOT_HAS_JUNGLE_COLD_WAR', 'REQUIREMENTSET_TEST_ALL'), 
('REQSET_CCB_PLOT_HAS_FOREST_COLD_WAR', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_PLOT_HAS_JUNGLE_COLD_WAR', 'REQUIRES_PLOT_HAS_NO_IMPROVEMENT'), 
('REQSET_CCB_PLOT_HAS_JUNGLE_COLD_WAR', 'PLOT_IS_JUNGLE_REQUIREMENT'), 
('REQSET_CCB_PLOT_HAS_JUNGLE_COLD_WAR', 'BBG_UTILS_PLAYER_HAS_CIVIC_COLD_WAR_REQUIREMENT'), 
