...
-- 2026/02/26 Trade Policy : Min era is now Start (from Medieval) 
UPDATE Resolutions SET EarliestEra=NULL WHERE ResolutionType='WC_RES_TRADE_TREATY';
-- 2026/02/26 Max era is now Future (from Information)
...
-- 2026/02/26 A Vote now also give +2 gold per trade route received to the chosen player
...
-- 2026/02/26 : Max era is now industrial
...
-- 2026/02/26 Urban Development Treaty : Max era is now Industrial (from Modern) 
UPDATE Resolutions SET LatestEra='ERA_INDUSTRIAL' WHERE ResolutionType='WC_RES_URBAN_DEVELOPMENT';

-- 2026/02/26 B Vote now allow buildings production but with a 50% production malus (from no buildings can be created in this district)
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
...
-- 2026/02/26 Patronage : Max era is now Future (from Modern)
...
-- 2026/02/26 Military Advisory : Max era is now Future (from Modern)
...
-- 2026/02/26 Migration Treaty : Min era is now Start (from Medieval)
UPDATE Resolutions SET EarliestEra=NULL WHERE ResolutionType='WC_RES_MIGRATION_TREATY';
-- 2026/02/26 Max era is now Renaissance (from Information)
...
-- 2026/02/26 Public Works Program : Max era is now Future (from Information)
...
-- 2026/02/26 Deforestation Treaty : Min era is now Renaissance (from Industrial) 
UPDATE Resolutions SET EarliestEra='ERA_RENAISSANCE' WHERE ResolutionType='WC_RES_DEFORESTATION_TREATY';

-- 2026/02/26 Deforestation Treaty : Max era is now Future (from Information)
...
-- 2026/02/26 Heritage Organization : B Vote is now -50% to chose type of Great Work (from no tourism)
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
