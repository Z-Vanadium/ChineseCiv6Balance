...
-- 2026/02/26 global prod malus reduced to -5% (from -10%)
...
-- 2026/06/02 no need foreign trade
-- 2026/02/26 extra faith need civic foreign trade
...
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_MALI_FAITH_NEXT_DESERT', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', NULL, 'BBG_CITY_CENTER_DESERT_REQSET'),
    ('BBG_MALI_FAITH_NEXT_DESERT_HILLS', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', NULL, 'BBG_CITY_CENTER_DESERT_HILLS_REQSET'),
    ('BBG_MALI_FAITH_NEXT_CAPITAL', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', NULL, 'BBG_CITY_CENTER_CAPITAL_NO_DESERT_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MALI_FAITH_NEXT_DESERT', 'YieldType', 'YIELD_FAITH'),
    ('BBG_MALI_FAITH_NEXT_DESERT', 'Amount', 1),
    ('BBG_MALI_FAITH_NEXT_DESERT_HILLS', 'YieldType', 'YIELD_FAITH'),
    ('BBG_MALI_FAITH_NEXT_DESERT_HILLS', 'Amount', 1),
    ('BBG_MALI_FAITH_NEXT_CAPITAL', 'YieldType', 'YIELD_FAITH'),
    ('BBG_MALI_FAITH_NEXT_CAPITAL', 'Amount', 1);
...
-- 2026/06/30 沙漠平原 +2 食物（无奇观）
-- 2025/10/11 flat desert no longer +2 food
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_PLOT_IS_DESERT_NO_CITY_CENTER_REQSET', 'REQ_CCB_PLOT_HAS_NO_FEATURE'),
...
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
    ...
    ('REQ_CCB_PLOT_HAS_NO_FEATURE', 'REQUIREMENT_PLOT_HAS_ANY_FEATURE', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
...
-- CCB Add 1 Prodcution ON unimproved Desert
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MALI_PRODUCTION_DESERT', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET'),
    ('BBG_MALI_PRODUCTION_DESERT_HILLS', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'CCB_PLOT_IS_DESERT_HILLS_NO_CITY_CENTER_AND_UNIMPROVED_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MALI_PRODUCTION_DESERT', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_MALI_PRODUCTION_DESERT', 'Amount', 1),
    ('BBG_MALI_PRODUCTION_DESERT_HILLS', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_MALI_PRODUCTION_DESERT_HILLS', 'Amount', 1);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_CIVILIZATION_MALI_GOLD_DESERT', 'BBG_MALI_PRODUCTION_DESERT'),
    ('TRAIT_CIVILIZATION_MALI_GOLD_DESERT', 'BBG_MALI_PRODUCTION_DESERT_HILLS');


INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQUIRES_PLOT_HAS_DESERT'), 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQUIRES_PLOT_HAS_NO_FLOODPLAINS'), 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'BBG_PLOT_HAS_NO_OASIS'), 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'BBG_REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'), 
    ('CCB_PLOT_IS_DESERT_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQ_CCB_PLOT_HAS_NO_IMPROVEMENT');
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES 
    ('REQ_CCB_PLOT_HAS_NO_IMPROVEMENT', 'REQUIREMENT_PLOT_HAS_ANY_IMPROVEMENT', 1);

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
    ('CCB_PLOT_IS_DESERT_HILLS_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
    ('CCB_PLOT_IS_DESERT_HILLS_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQUIRES_PLOT_HAS_DESERT_HILLS'), 
    ('CCB_PLOT_IS_DESERT_HILLS_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'BBG_REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'), 
    ('CCB_PLOT_IS_DESERT_HILLS_NO_CITY_CENTER_AND_UNIMPROVED_REQSET', 'REQ_CCB_PLOT_HAS_NO_IMPROVEMENT');