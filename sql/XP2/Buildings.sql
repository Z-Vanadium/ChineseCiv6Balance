...
-- 2025/12/24 +2 niter from armories(from +1)
...
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_OIL_SEAPORT_BONUS', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_OIL');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
UPDATE Building_YieldChangesBonusWithPower SET YieldChange=14 WHERE BuildingType='BUILDING_STOCK_EXCHANGE' AND YieldType='YIELD_GOLD';
