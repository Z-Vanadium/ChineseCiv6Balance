...
-- 2026/07/12 总督升级带来的学院建筑产出降低至 20%（而不是 30%）；无总督城市的全产惩罚降低至 5%（而不是 10%）
...
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_1_GOV_TITLE', 'Amount', 20),
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_2_GOV_TITLE', 'Amount', 20),
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_3_GOV_TITLE', 'Amount', 20),
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_4_GOV_TITLE', 'Amount', 20),
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_5_GOV_TITLE', 'Amount', 20),
    ...
    ('BBG_SEONDEOK_YIELD_SEOWON_BUILDING_FOR_6_GOV_TITLE', 'Amount', 20);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
...
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_SEONDEOK_MINUS_AFTER_FEUDALISM_SEOWON_NO_GOV', 'Amount', '-5, -5, -5, -5, -5, -5');
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
