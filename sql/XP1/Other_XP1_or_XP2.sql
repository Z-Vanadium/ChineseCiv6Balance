...
INSERT INTO Modifiers(ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId)
	SELECT 'BBG_MILITARY_COMMEMORATION_'||Resources.ResourceType||'_ACCUMULATION_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'PLAYER_HAS_GOLDEN_AGE', 'BBG_PLAYER_CAN_SEE_'||REPLACE(Resources.ResourceType, 'RESOURCE_','')
...
INSERT INTO Modifiers(ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId)
	SELECT 'BBG_DRUMS_COMMEMORATION_'||Resources.ResourceType||'_ACCUMULATION_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'PLAYER_HAS_GOLDEN_AGE', 'BBG_PLAYER_CAN_SEE_'||REPLACE(Resources.ResourceType, 'RESOURCE_','')
...
-- 2025/10/24 added for lvl 2 economic alliance
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
...
INSERT INTO AllianceEffects (LevelRequirement, AllianceType, ModifierID) VALUES
	(2, 'ALLIANCE_ECONOMIC', 'ALLIANCE_ADD_PROD_TO_ORIGIN_TRADE_ROUTE'),
	(2, 'ALLIANCE_ECONOMIC', 'ALLIANCE_ADD_PROD_TO_DESTINATION_TRADE_ROUTE');
