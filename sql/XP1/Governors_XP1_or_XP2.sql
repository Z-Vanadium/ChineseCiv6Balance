...
-- 2026/06/30 重做为六环内城市：寺庙+1科文、祭祀建筑+1科文
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ...
    ('GOVERNOR_PROMOTION_CARDINAL_PATRON_SAINT', 'CCB_MOKSHA_BUILDING_HS_T3_YIELD_SCIENCE'),
    ('GOVERNOR_PROMOTION_CARDINAL_PATRON_SAINT', 'CCB_MOKSHA_BUILDING_HS_T3_YIELD_CULTURE');

INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_REQUIRES_PLOT_SIX_TILES_AWAY_REQSET'),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_REQUIRES_PLOT_SIX_TILES_AWAY_REQSET'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_SCIENCE', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_REQUIRES_PLOT_SIX_TILES_AWAY_REQSET'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_CULTURE', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_REQUIRES_PLOT_SIX_TILES_AWAY_REQSET');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE', 'ModifierId', 'CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE_MODIFIER'),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE', 'ModifierId', 'CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE_MODIFIER'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_SCIENCE', 'ModifierId', 'CCB_MOKSHA_BUILDING_HS_T3_YIELD_SCIENCE_MODIFIER'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_CULTURE', 'ModifierId', 'CCB_MOKSHA_BUILDING_HS_T3_YIELD_CULTURE_MODIFIER');

INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_YIELD_CHANGE', 'REQSET_CCB_CITY_HAS_BUILDING_TEMPLE'),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_YIELD_CHANGE', 'REQSET_CCB_CITY_HAS_BUILDING_TEMPLE'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_SCIENCE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_YIELD_CHANGE', 'REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3'),
    ('CCB_MOKSHA_BUILDING_HS_T3_YIELD_CULTURE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_YIELD_CHANGE', 'REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE_MODIFIER', 'YieldType', 'YIELD_SCIENCE'),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_SCIENCE_MODIFIER', 'Amount', 1),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE_MODIFIER', 'YieldType', 'YIELD_CULTURE'),
    ('CCB_MOKSHA_BUILDING_TEMPLE_YIELD_CULTURE_MODIFIER', 'Amount', 1),
...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ...
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQUIREMENTSET_TEST_ANY');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('REQSET_CCB_CITY_HAS_BUILDING_TEMPLE', 'REQ_CCB_CITY_HAS_BUILDING_TEMPLE'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_CATHEDRAL'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_GURDWARA'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_MEETING_HOUSE'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_MOSQUE'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_PAGODA'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_SYNAGOGUE'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_WAT'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_STUPA'),
    ('REQSET_CCB_CITY_HAS_BUILDING_HOLY_SITE_T3', 'REQ_CCB_CITY_HAS_BUILDING_DAR_E_MEHR');

INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ('REQ_CCB_CITY_HAS_BUILDING_TEMPLE', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_CATHEDRAL', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_GURDWARA', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_MEETING_HOUSE', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_MOSQUE', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_PAGODA', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_SYNAGOGUE', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_WAT', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_STUPA', 'REQUIREMENT_CITY_HAS_BUILDING'),
    ('REQ_CCB_CITY_HAS_BUILDING_DAR_E_MEHR', 'REQUIREMENT_CITY_HAS_BUILDING');

INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
    ('REQ_CCB_CITY_HAS_BUILDING_TEMPLE', 'BuildingType', 'BUILDING_TEMPLE'),
    ('REQ_CCB_CITY_HAS_BUILDING_CATHEDRAL', 'BuildingType', 'BUILDING_CATHEDRAL'),
    ('REQ_CCB_CITY_HAS_BUILDING_GURDWARA', 'BuildingType', 'BUILDING_GURDWARA'),
    ('REQ_CCB_CITY_HAS_BUILDING_MEETING_HOUSE', 'BuildingType', 'BUILDING_MEETING_HOUSE'),
    ('REQ_CCB_CITY_HAS_BUILDING_MOSQUE', 'BuildingType', 'BUILDING_MOSQUE'),
    ('REQ_CCB_CITY_HAS_BUILDING_PAGODA', 'BuildingType', 'BUILDING_PAGODA'),
    ('REQ_CCB_CITY_HAS_BUILDING_SYNAGOGUE', 'BuildingType', 'BUILDING_SYNAGOGUE'),
    ('REQ_CCB_CITY_HAS_BUILDING_WAT', 'BuildingType', 'BUILDING_WAT'),
    ('REQ_CCB_CITY_HAS_BUILDING_STUPA', 'BuildingType', 'BUILDING_STUPA'),
    ('REQ_CCB_CITY_HAS_BUILDING_DAR_E_MEHR', 'BuildingType', 'BUILDING_DAR_E_MEHR');
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('GOVERNOR_PROMOTION_RESOURCE_MANAGER_SURPLUS_LOGISTICS', 'INDUSTRIALIST_RESOURCE_POWER_PROVIDED');
...
-- 2026/07/02 移除工业区建筑产出加成，修改为工业区地基和每级建筑使得相邻加成+2锤；电力移动到 LII
INSERT INTO Types (Type, Kind) VALUES 
('MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES 
('MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 'COLLECTION_OWNER', 'EFFECT_DISTRICT_ADJACENCY');
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES 
('GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER', 'CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS'),
('GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER', 'CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1'),
('GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER', 'CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2'),
('GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER', 'CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3');
...
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS', 'MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 0, 0, 0, NULL, NULL, 1, 1),
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1', 'MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 0, 0, 0, 'REQSET_CCB_CITY_HAS_BUILDING_WORKSHOP', NULL, 1, 1),
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2', 'MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 0, 0, 0, 'REQSET_CCB_CITY_HAS_BUILDING_FACTORY', NULL, 1, 1),
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3', 'MODIFIER_CCB_GOVERNOR_ADJUST_CITIY_DISTRICT_ADJACENCY', 0, 0, 0, 'REQSET_CCB_CITY_HAS_ANY_IZ_T3', NULL, 1, 1);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS', 'Amount', '2'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS', 'Description', 'LOC_CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_DESCRIPTION'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS', 'DistrictType', 'DISTRICT_INDUSTRIAL_ZONE'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS', 'YieldType', 'YIELD_PRODUCTION'),

('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1', 'Amount', '2'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1', 'Description', 'LOC_CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1_DESCRIPTION'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1', 'DistrictType', 'DISTRICT_INDUSTRIAL_ZONE'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T1', 'YieldType', 'YIELD_PRODUCTION'),

('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2', 'Amount', '2'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2', 'Description', 'LOC_CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2_DESCRIPTION'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2', 'DistrictType', 'DISTRICT_INDUSTRIAL_ZONE'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T2', 'YieldType', 'YIELD_PRODUCTION'),

('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3', 'Amount', '2'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3', 'Description', 'LOC_CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3_DESCRIPTION'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3', 'DistrictType', 'DISTRICT_INDUSTRIAL_ZONE'), 
('CCB_BLACK_MARKETEER_IZ_ADJACENT_BONUS_T3', 'YieldType', 'YIELD_PRODUCTION');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_CITY_HAS_BUILDING_WORKSHOP', 'REQUIREMENTSET_TEST_ALL'),
('REQSET_CCB_CITY_HAS_BUILDING_FACTORY', 'REQUIREMENTSET_TEST_ALL'),
('REQSET_CCB_CITY_HAS_ANY_IZ_T3', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_CITY_HAS_BUILDING_WORKSHOP', 'REQ_CCB_CITY_HAS_BUILDING_WORKSHOP'),
('REQSET_CCB_CITY_HAS_BUILDING_FACTORY', 'REQ_CCB_CITY_HAS_BUILDING_FACTORY'),
('REQSET_CCB_CITY_HAS_ANY_IZ_T3', 'REQ_CCB_CITY_HAS_BUILDING_COAL_POWER_PLANT'),
('REQSET_CCB_CITY_HAS_ANY_IZ_T3', 'REQ_CCB_CITY_HAS_BUILDING_FOSSIL_FUEL_POWER_PLANT'),
('REQSET_CCB_CITY_HAS_ANY_IZ_T3', 'REQ_CCB_CITY_HAS_BUILDING_POWER_PLANT');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_CITY_HAS_BUILDING_WORKSHOP', 'REQUIREMENT_CITY_HAS_BUILDING'),
('REQ_CCB_CITY_HAS_BUILDING_FACTORY', 'REQUIREMENT_CITY_HAS_BUILDING'),
('REQ_CCB_CITY_HAS_BUILDING_COAL_POWER_PLANT', 'REQUIREMENT_CITY_HAS_BUILDING'),
('REQ_CCB_CITY_HAS_BUILDING_FOSSIL_FUEL_POWER_PLANT', 'REQUIREMENT_CITY_HAS_BUILDING'),
('REQ_CCB_CITY_HAS_BUILDING_POWER_PLANT', 'REQUIREMENT_CITY_HAS_BUILDING');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_CITY_HAS_BUILDING_WORKSHOP', 'BuildingType', 'BUILDING_WORKSHOP'),
('REQ_CCB_CITY_HAS_BUILDING_FACTORY', 'BuildingType', 'BUILDING_FACTORY'),
('REQ_CCB_CITY_HAS_BUILDING_COAL_POWER_PLANT', 'BuildingType', 'BUILDING_COAL_POWER_PLANT'),
('REQ_CCB_CITY_HAS_BUILDING_FOSSIL_FUEL_POWER_PLANT', 'BuildingType', 'BUILDING_FOSSIL_FUEL_POWER_PLANT'),
('REQ_CCB_CITY_HAS_BUILDING_POWER_PLANT', 'BuildingType', 'BUILDING_POWER_PLANT');
...
-- Default Land Acquisition : Acquire new tiles in the city faster +20% speed. +4 golds for foreign traders going through this city.
...
DELETE FROM GovernorPromotionModifiers
      WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER' AND
            ModifierId IN ('HARBORMASTER_BONUS_COMMERCIAL_HUB_ADJACENCY', 'HARBORMASTER_BONUS_HARBOR_ADJACENCY');

INSERT INTO GovernorPromotionModifiers VALUES
    ('GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER', 'TAX_COLLECTOR_ADJUST_CITIZEN_GPT'),
    ('GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER', 'CCB_REYNA_TRADEROUTE_LATE');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId) VALUES
    ('CCB_REYNA_TRADEROUTE_LATE', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_CAPACITY', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
DELETE FROM GovernorPromotionModifiers
      WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR' AND
            ModifierId = 'TAX_COLLECTOR_ADJUST_CITIZEN_GPT';

INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR', 'CONTRACTOR_ENABLE_DISTRICT_PURCHASE'),
    ('GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR', 'CCB_REYNA_DISTRICT_GOLD_DISCOUNT');
...
-- 2026/06/30 新增港商相邻翻倍；金币购买区域的能力移动到 MII
DELETE FROM GovernorPromotionModifiers
      WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR' AND
            ModifierId = 'CONTRACTOR_ENABLE_DISTRICT_PURCHASE';

INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR', 'HARBORMASTER_BONUS_COMMERCIAL_HUB_ADJACENCY'),
    ('GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR', 'HARBORMASTER_BONUS_HARBOR_ADJACENCY');
...
-- 2026/06/30 新增同时拥有市场和灯塔+1商路
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('BBG_GOVERNOR_PROMOTION_MANAGER', 'BBG_REYNA_TRADEROUTE_FROM_MARKET_LIGHTHOUSE');
