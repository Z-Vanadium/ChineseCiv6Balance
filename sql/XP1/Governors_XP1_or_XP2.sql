...
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ...
    ('BBG_MOKSHA_PROPHET_POINTS', 'Amount', 2);
INSERT INTO GovernorPromotionModifiers(GovernorPromotionType, ModifierId) VALUES
...
-- 10% faith transformed into culture and science with civic reformed church
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId) VALUES 
    ('BBG_MOKSHA_FAITH_IN_CULTURE_REFORMED_CHURCH', 'BBG_MODIFIER_SINGLE_CITY_ADJUST_YIELD_MODIFIER_FROM_FAITH', 'BBG_UTILS_PLAYER_HAS_CIVIC_REFORMED_CHURCH_REQSET'),
    ('BBG_MOKSHA_FAITH_IN_SCIENCE_REFORMED_CHURCH', 'BBG_MODIFIER_SINGLE_CITY_ADJUST_YIELD_MODIFIER_FROM_FAITH', 'BBG_UTILS_PLAYER_HAS_CIVIC_REFORMED_CHURCH_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MOKSHA_FAITH_IN_CULTURE_REFORMED_CHURCH', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_MOKSHA_FAITH_IN_CULTURE_REFORMED_CHURCH', 'Amount', 10),
    ('BBG_MOKSHA_FAITH_IN_SCIENCE_REFORMED_CHURCH', 'YieldType', 'YIELD_SCIENCE'),
    ('BBG_MOKSHA_FAITH_IN_SCIENCE_REFORMED_CHURCH', 'Amount', 10);
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('GOVERNOR_PROMOTION_CARDINAL_PATRON_SAINT', 'BBG_MOKSHA_FAITH_IN_CULTURE_REFORMED_CHURCH'),
    ('GOVERNOR_PROMOTION_CARDINAL_PATRON_SAINT', 'BBG_MOKSHA_FAITH_IN_SCIENCE_REFORMED_CHURCH');
...
-- 2025/10/12 swap RII black marketeer and LI expedition
UPDATE GovernorPromotions SET Level=1, Column=0 WHERE GovernorPromotionType='GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER';
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_RESOURCE_MANAGER_GROUNDBREAKER' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER';
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_RESOURCE_MANAGER_SURPLUS_LOGISTICS';
...
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_RESOURCE_MANAGER_INDUSTRIALIST' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION';
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_RESOURCE_MANAGER_VERTICAL_INTEGRATION' AND PrereqGovernorPromotion='GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER';

-- RII to +2 prod for domestic trade route
UPDATE ModifierArguments SET Value=2 WHERE ModifierId='BBG_MAGNUS_DOMESTIC_TRADE_ROUTE_PROD' AND Name='Amount';
...
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
    ('BBG_VIKTOR_PRODUCTION_UNITS', 'MODIFIER_GOVERNOR_ADJUST_CITY_MILITARY_UNIT_PRODUCTION');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
-- 30/06/25 Delayed to Economics
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId) VALUES
    ('BBG_REYNA_SCIENCE_FROM_FOREIGN_TRADER_ECONOMICS', 'MODIFIER_CITY_ADJUST_YIELD_FROM_FOREIGN_TRADE_ROUTES_PASSING_THROUGH', 'BBG_UTILS_PLAYER_HAS_TECH_ECONOMICS'),
    ('BBG_REYNA_CULTURE_FROM_FOREIGN_TRADER_ECONOMICS', 'MODIFIER_CITY_ADJUST_YIELD_FROM_FOREIGN_TRADE_ROUTES_PASSING_THROUGH', 'BBG_UTILS_PLAYER_HAS_TECH_ECONOMICS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_REYNA_SCIENCE_FROM_FOREIGN_TRADER_ECONOMICS', 'YieldType', 'YIELD_SCIENCE'),
    ('BBG_REYNA_SCIENCE_FROM_FOREIGN_TRADER_ECONOMICS', 'Amount', 1),
    ('BBG_REYNA_CULTURE_FROM_FOREIGN_TRADER_ECONOMICS', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_REYNA_CULTURE_FROM_FOREIGN_TRADER_ECONOMICS', 'Amount', 1);
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('BBG_GOVERNOR_PROMOTION_MANAGER', 'BBG_REYNA_SCIENCE_FROM_FOREIGN_TRADER_ECONOMICS'),
    ('BBG_GOVERNOR_PROMOTION_MANAGER', 'BBG_REYNA_CULTURE_FROM_FOREIGN_TRADER_ECONOMICS');