...
-- 2026/08/07 军事组织政策卡不再提供大将军移动力，动员新增被动效果：大将军和海军统帅基础移速+2
DELETE FROM PolicyModifiers WHERE PolicyType='POLICY_MILITARY_ORGANIZATION' AND ModifierId='MILITARYORGANIZATION_GREATGENERAL_MOVEMENT';

INSERT INTO CivicModifiers (CivicType, ModifierId) VALUES 
('CIVIC_MOBILIZATION', 'CCB_MOBILIZATION_GP_MOVEMENT_BONUS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT', 0, 0, 0, NULL, 'REQSET_CCB_MOBILIZATION_GP_MOVEMENT_BONUS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'Amount', '2');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'REQ_CCB_UNIT_IS_GREAT_ADMIRAL'), 
('REQSET_CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'REQ_CCB_UNIT_IS_GREAT_GENERAL'), 
('REQSET_CCB_MOBILIZATION_GP_MOVEMENT_BONUS', 'REQ_CCB_UNIT_IS_COMANDANTE_GENERAL');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_UNIT_IS_GREAT_ADMIRAL', 'REQUIREMENT_UNIT_TYPE_MATCHES'), 
('REQ_CCB_UNIT_IS_GREAT_GENERAL', 'REQUIREMENT_UNIT_TYPE_MATCHES'), 
('REQ_CCB_UNIT_IS_COMANDANTE_GENERAL', 'REQUIREMENT_UNIT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_UNIT_IS_GREAT_ADMIRAL', 'UnitType', 'UNIT_GREAT_ADMIRAL'), 
('REQ_CCB_UNIT_IS_GREAT_GENERAL', 'UnitType', 'UNIT_GREAT_GENERAL'), 
('REQ_CCB_UNIT_IS_COMANDANTE_GENERAL', 'UnitType', 'UNIT_COMANDANTE_GENERAL');