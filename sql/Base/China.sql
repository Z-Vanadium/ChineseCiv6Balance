...
-- 2025/12/13 Qinshi special districts get +1 yield per wonder adjacent
...
VALUES 
('CCB_DISTRICT_CAMPUS_YIELD_SCIENCE_FROM_WONDER', 'DISTRICT_CAMPUS', 'SelfBonus', 'YIELD_SCIENCE', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0),
('CCB_DISTRICT_COMMERCIAL_HUB_YIELD_GOLD_FROM_WONDER', 'DISTRICT_COMMERCIAL_HUB', 'SelfBonus', 'YIELD_GOLD', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0),
('CCB_DISTRICT_HOLY_SITE_YIELD_FAITH_FROM_WONDER', 'DISTRICT_HOLY_SITE', 'SelfBonus', 'YIELD_FAITH', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0),
('CCB_DISTRICT_INDUSTRIAL_ZONE_YIELD_PRODUCTION_FROM_WONDER', 'DISTRICT_INDUSTRIAL_ZONE', 'SelfBonus', 'YIELD_PRODUCTION', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0),
('CCB_DISTRICT_HARBOR_YIELD_GOLD_FROM_WONDER', 'DISTRICT_HARBOR', 'SelfBonus', 'YIELD_GOLD', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0),
('CCB_DISTRICT_THEATER_YIELD_CULTURE_FROM_WONDER', 'DISTRICT_THEATER', 'SelfBonus', 'YIELD_CULTURE', 1, 'FROM_ADJACENT_WONDERS', 'NONE', 0, 'FIRST_EMPEROR_TRAIT', 'DistrictModifiers', NULL, 'COLLECTION_CITY_DISTRICTS', 'Human&AI', 0);

INSERT INTO Ruivo_New_Adjacency_Text (ID, Tooltip) VALUES
('CCB_DISTRICT_CAMPUS_YIELD_SCIENCE_FROM_WONDER','LOC_CCB_DISTRICT_CAMPUS_YIELD_SCIENCE_FROM_WONDER'),
('CCB_DISTRICT_COMMERCIAL_HUB_YIELD_GOLD_FROM_WONDER','LOC_CCB_DISTRICT_COMMERCIAL_HUB_YIELD_GOLD_FROM_WONDER'),
('CCB_DISTRICT_HOLY_SITE_YIELD_FAITH_FROM_WONDER','LOC_CCB_DISTRICT_HOLY_SITE_YIELD_FAITH_FROM_WONDER'),
('CCB_DISTRICT_INDUSTRIAL_ZONE_YIELD_PRODUCTION_FROM_WONDER','LOC_CCB_DISTRICT_INDUSTRIAL_ZONE_YIELD_PRODUCTION_FROM_WONDER'),
('CCB_DISTRICT_HARBOR_YIELD_GOLD_FROM_WONDER','LOC_CCB_DISTRICT_HARBOR_YIELD_GOLD_FROM_WONDER'),
('CCB_DISTRICT_THEATER_YIELD_CULTURE_FROM_WONDER','LOC_CCB_DISTRICT_THEATER_YIELD_CULTURE_FROM_WONDER');
