...
-- 2026/04/23: nerfed to +5/+10
-- 30/03/25 Religious community +8/16 gold per shrine/temple
DELETE From BeliefModifiers WHERE BeliefType='BELIEF_RELIGIOUS_COMMUNITY';
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_GIVER', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_RELIGION_HAS_SHRINE'),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_GIVER', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_RELIGION_HAS_TEMPLE'),
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_MODIFIER', 'MODIFIER_BUILDING_YIELD_CHANGE', null ),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_MODIFIER', 'MODIFIER_BUILDING_YIELD_CHANGE', null );
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_GIVER', 'ModifierId', 'BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_MODIFIER'),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_GIVER', 'ModifierId', 'BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_MODIFIER'),
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_MODIFIER', 'BuildingType', 'BUILDING_SHRINE' ),
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_MODIFIER', 'YieldType', 'YIELD_GOLD'),
    ('BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_MODIFIER', 'Amount', 5),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_MODIFIER', 'BuildingType', 'BUILDING_TEMPLE' ),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_MODIFIER', 'YieldType', 'YIELD_GOLD'),
    ('BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_MODIFIER', 'Amount', 10);
INSERT INTO BeliefModifiers (BeliefType, ModifierId) VALUES 
    ('BELIEF_RELIGIOUS_COMMUNITY', 'BBG_RELIGIOUS_COMMUNITY_SHRINE_GOLD_GIVER'),
    ('BELIEF_RELIGIOUS_COMMUNITY', 'BBG_RELIGIOUS_COMMUNITY_TEMPLE_GOLD_GIVER');