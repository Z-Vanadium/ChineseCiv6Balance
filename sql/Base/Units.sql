...
-- 2025/12/08 at_crew and modern at +1 movement
UPDATE Units SET Combat=80, BaseMoves=3 WHERE UnitType='UNIT_AT_CREW';
...
-- 2026/04/23: sepc ops gets L1, R1 and L2
INSERT INTO Tags (Tag, Vocabulary) VALUES ('CLASS_CCB_SPEC_OPS', 'ABILITY_CLASS');
INSERT INTO Types (Type, Kind) VALUES
    ('BBG_ABILITY_SPEC_OPS_L1', 'KIND_ABILITY'),
    ('BBG_ABILITY_SPEC_OPS_R1', 'KIND_ABILITY'),
    ('BBG_ABILITY_SPEC_OPS_L2', 'KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES 
    ('UNIT_SPEC_OPS', 'CLASS_CCB_SPEC_OPS'),
    ('BBG_ABILITY_SPEC_OPS_L1', 'CLASS_CCB_SPEC_OPS'),
    ('BBG_ABILITY_SPEC_OPS_R1', 'CLASS_CCB_SPEC_OPS'),
    ('BBG_ABILITY_SPEC_OPS_L2', 'CLASS_CCB_SPEC_OPS');
INSERT INTO UnitAbilities(UnitAbilityType, Name, Description, Inactive) VALUES
    ('BBG_ABILITY_SPEC_OPS_L1', 'LOC_BBG_ABILITY_SPEC_OPS_L1_NAME', 'LOC_BBG_ABILITY_SPEC_OPS_L1_DESC', 0),
    ('BBG_ABILITY_SPEC_OPS_R1', 'LOC_BBG_ABILITY_SPEC_OPS_R1_NAME', 'LOC_BBG_ABILITY_SPEC_OPS_R1_DESC', 0),
    ('BBG_ABILITY_SPEC_OPS_L2', 'LOC_BBG_ABILITY_SPEC_OPS_L2_NAME', 'LOC_BBG_ABILITY_SPEC_OPS_L2_DESC', 0);
INSERT INTO UnitAbilityModifiers(UnitAbilityType, ModifierId) VALUES
    ('BBG_ABILITY_SPEC_OPS_L1', 'RANGER_IGNORE_FOREST_MOVEMENT_PENALTY'),
    ('BBG_ABILITY_SPEC_OPS_R1', 'ALPINE_IGNORE_HILLS_MOVEMENT_PENALTY'),
    ('BBG_ABILITY_SPEC_OPS_L2', 'SENTRY_SEE_THROUGH_FEATURES');
...
-- 2026/07/12 抗骑兵及其UU不再过时；野战加农炮不再过时
UPDATE Units SET MandatoryObsoleteTech=NULL WHERE UnitType='UNIT_FIELD_CANNON';
...
-- 2025/09/23 medic cannot grants movement bonus to units multiply
UPDATE Modifiers SET SubjectStackLimit=1 WHERE ModifierId IN ('BBG_MEDIC_MELEE_MOVEMENT', 'BBG_MEDIC_RANGED_MOVEMENT', 'BBG_MEDIC_ANTICAV_MOVEMENT');
...
INSERT INTO TypeTags (Type, Tag) VALUES
    ('UNIT_MACHINE_GUN', 'CLASS_MACHINE_GUN'),
    ('ABILITY_CCB_MACHINE_GUN_RANGE_LATE', 'CLASS_MACHINE_GUN');
