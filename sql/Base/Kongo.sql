...
-- 2026/06/02 gpp remove, for female leader Mbande only
DELETE FROM TraitModifiers
      WHERE TraitType = 'TRAIT_CIVILIZATION_NKISI' AND
            ModifierId IN ('TRAIT_DOUBLE_ARTIST_POINTS', 'TRAIT_DOUBLE_MERCHANT_POINTS', 'TRAIT_DOUBLE_MUSICIAN_POINTS', 'TRAIT_DOUBLE_WRITER_POINTS');
...
-- 2026/06/02 reverted
-- INSERT INTO Types (Type, Kind) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED', 'KIND_ABILITY');
-- INSERT INTO TypeTags (Type, Tag) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED', 'CLASS_MELEE'),
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED', 'CLASS_ANTI_CAVALRY');

-- INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
--     ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_GIVER');
-- INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_GIVER', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 1, 0, NULL, NULL);
-- INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_GIVER', 'AbilityType', 'CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED');

-- INSERT INTO UnitAbilities (UnitAbilityType, Name, Description, Inactive) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED', 'LOC_CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_NAME', 'LOC_CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_DESC', 1);
-- INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED', 'CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_MODIFIER');
-- INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_MODIFIER', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 'NAGAO_RANGED_DEFENSE_REQUIREMENTS');
-- INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_MODIFIER', 'Amount', '5');
-- INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
--     ('CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_MODIFIER', 'Preview', 'LOC_CCB_MELEE_AND_ANTI_CAVALRY_DEFENSE_RANGED_DESC');

-- 2026/06/02 melee kongo: +3 attacking strength when in forest or jungle for melee and anti cavalry, cavalry
INSERT INTO Types (Type, Kind) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH', 'KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH', 'CLASS_MELEE'),
    ('CCB_KONGO_ATTACK_STRENGTH', 'CLASS_ANTI_CAVALRY'),
    ('CCB_KONGO_ATTACK_STRENGTH', 'CLASS_LIGHT_CAVALRY'),
    ('CCB_KONGO_ATTACK_STRENGTH', 'CLASS_HEAVY_CAVALRY');
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'CCB_KONGO_ATTACK_STRENGTH_GIVER');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH_GIVER', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 1, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH_GIVER', 'AbilityType', 'CCB_KONGO_ATTACK_STRENGTH');
INSERT INTO UnitAbilities (UnitAbilityType, Name, Description, Inactive) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH', 'LOC_CCB_KONGO_ATTACK_STRENGTH_NAME', 'LOC_CCB_KONGO_ATTACK_STRENGTH_DESC', 1);
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH', 'CCB_KONGO_ATTACK_STRENGTH_FOREST_MODIFIER'),
    ('CCB_KONGO_ATTACK_STRENGTH', 'CCB_KONGO_ATTACK_STRENGTH_JUNGLE_MODIFIER');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
    ('CCB_KONGO_ATTACK_STRENGTH_FOREST_MODIFIER', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQSET_CCB_KONGO_ATTACK_STRENGTH_FOREST'),
    ('CCB_KONGO_ATTACK_STRENGTH_JUNGLE_MODIFIER', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQSET_CCB_KONGO_ATTACK_STRENGTH_JUNGLE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
    ('CCB_KONGO_ATTACK_STRENGTH_FOREST_MODIFIER', 'Amount', '3'),
    ('CCB_KONGO_ATTACK_STRENGTH_JUNGLE_MODIFIER', 'Amount', '3');
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
    ('CCB_KONGO_ATTACK_STRENGTH_FOREST_MODIFIER', 'Preview', 'LOC_CCB_KONGO_ATTACK_STRENGTH_DESC'),
    ('CCB_KONGO_ATTACK_STRENGTH_JUNGLE_MODIFIER', 'Preview', 'LOC_CCB_KONGO_ATTACK_STRENGTH_DESC');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_FOREST', 'REQUIREMENTSET_TEST_ALL'),
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_JUNGLE', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_FOREST', 'PLAYER_IS_ATTACKER_REQUIREMENTS'), 
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_JUNGLE', 'PLAYER_IS_ATTACKER_REQUIREMENTS'),
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_FOREST', 'PLOT_IS_FOREST_REQUIREMENT'),
    ('REQSET_CCB_KONGO_ATTACK_STRENGTH_JUNGLE', 'CCB_PLOT_IS_JUNGLE_REQUIREMENT');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
    ('CCB_PLOT_IS_JUNGLE_REQUIREMENT', 'REQUIREMENT_PLOT_FEATURE_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
    ('CCB_PLOT_IS_JUNGLE_REQUIREMENT', 'FeatureType', 'FEATURE_JUNGLE');

-- +1 general gpp for barracks and stable
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_RELIGIOUS_CONVERT', 'CCB_KONGO_GENERAL_GPP');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_KONGO_GENERAL_GPP', 'MODIFIER_PLAYER_CITIES_ADJUST_GREAT_PERSON_POINT', 0, 0, 0, NULL, 'REQSET_CCB_KONGO_GENERAL_GPP');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_KONGO_GENERAL_GPP', 'Amount', '1'), 
('CCB_KONGO_GENERAL_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_GENERAL');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_KONGO_GENERAL_GPP', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_KONGO_GENERAL_GPP', 'REQ_CCB_CITY_HAS_STABLE'), 
('REQSET_CCB_KONGO_GENERAL_GPP', 'REQ_CCB_CITY_HAS_BARRACKS');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_CITY_HAS_STABLE', 'REQUIREMENT_CITY_HAS_BUILDING'), 
('REQ_CCB_CITY_HAS_BARRACKS', 'REQUIREMENT_CITY_HAS_BUILDING');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_CITY_HAS_STABLE', 'BuildingType', 'BUILDING_STABLE'), 
('REQ_CCB_CITY_HAS_BARRACKS', 'BuildingType', 'BUILDING_BARRACKS');

-- +1 general gpp for armory with ud
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_RELIGIOUS_CONVERT', 'CCB_KONGO_GENERAL_GPP_ARMORY');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_KONGO_GENERAL_GPP_ARMORY', 'MODIFIER_PLAYER_CITIES_ADJUST_GREAT_PERSON_POINT', 0, 0, 0, NULL, 'REQSET_CCB_KONGO_GENERAL_GPP_ARMORY');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_KONGO_GENERAL_GPP_ARMORY', 'Amount', '1'), 
('CCB_KONGO_GENERAL_GPP_ARMORY', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_GENERAL');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_KONGO_GENERAL_GPP_ARMORY', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_KONGO_GENERAL_GPP_ARMORY', 'REQ_CCB_CITY_HAS_ARMORY'),
('REQSET_CCB_KONGO_GENERAL_GPP_ARMORY', 'REQ_CCB_CITY_HAS_MBANZA');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES 
('REQ_CCB_CITY_HAS_ARMORY', 'REQUIREMENT_CITY_HAS_BUILDING'),
('REQ_CCB_CITY_HAS_MBANZA', 'REQUIREMENT_CITY_HAS_DISTRICT');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_CITY_HAS_ARMORY', 'BuildingType', 'BUILDING_ARMORY'),
('REQ_CCB_CITY_HAS_MBANZA', 'DistrictType', 'DISTRICT_MBANZA');
