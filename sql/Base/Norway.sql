...
-- 2026/07/12 海岸城市若没有港口，则圣地提供 +1 住房
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_UNIT_NORWEGIAN_BERSERKER', 'CCB_NORWAY_COASTAL_CITY_HOUSING');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_NORWAY_COASTAL_CITY_HOUSING', 'MODIFIER_PLAYER_CITIES_ADJUST_WATER_HOUSING', 0, 0, 0, NULL, 'REQSET_CCB_COASTAL_CITY_HAS_HS_WITHOUT_HARBOR');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_NORWAY_COASTAL_CITY_HOUSING', 'Amount', '1');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES 
('REQSET_CCB_COASTAL_CITY_HAS_HS_WITHOUT_HARBOR', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES 
('REQSET_CCB_COASTAL_CITY_HAS_HS_WITHOUT_HARBOR', 'PLOT_IS_COASTAL_LAND'), 
('REQSET_CCB_COASTAL_CITY_HAS_HS_WITHOUT_HARBOR', 'BBG_CITY_HAS_DISTRICT_HOLY_SITE_REQUIREMENT'), 
('REQSET_CCB_COASTAL_CITY_HAS_HS_WITHOUT_HARBOR', 'REQ_CCB_CITY_HAS_NO_DISTRICT_HARBOR');

INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES 
('REQ_CCB_CITY_HAS_NO_DISTRICT_HARBOR', 'REQUIREMENT_CITY_HAS_DISTRICT', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES 
('REQ_CCB_CITY_HAS_NO_DISTRICT_HARBOR', 'DistrictType', 'DISTRICT_HARBOR');