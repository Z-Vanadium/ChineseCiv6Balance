...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	...
	('BBG_CLEO_FASTER_THEATER_RIVER', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 'PLOT_ADJACENT_TO_RIVER_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('BBG_CLEO_FASTER_HUB_RIVER', 'DistrictType', 'DISTRICT_COMMERCIAL_HUB'),
	('BBG_CLEO_FASTER_HUB_RIVER', 'Amount', 15),
	('BBG_CLEO_FASTER_THEATER_RIVER', 'DistrictType', 'DISTRICT_THEATER'),
	('BBG_CLEO_FASTER_THEATER_RIVER', 'Amount', 15);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
	('TRAIT_LEADER_MEDITERRANEAN', 'BBG_CLEO_FASTER_HUB_RIVER'),
	('TRAIT_LEADER_MEDITERRANEAN', 'BBG_CLEO_FASTER_THEATER_RIVER');

-- 2025/10/11 cleo commercial hub and theater get +1 culture if next to river
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_MEDITERRANEAN', 'CCB_CLEO_CH_STANDARD_CULTURE_RIVER');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_CLEO_CH_STANDARD_CULTURE_RIVER', 'MODIFIER_PLAYER_CITIES_RIVER_ADJACENCY', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_CLEO_CH_STANDARD_CULTURE_RIVER', 'Amount', '1'), 
('CCB_CLEO_CH_STANDARD_CULTURE_RIVER', 'Description', 'LOC_CCB_DISTRICT_RIVER_CULTURE'), 
('CCB_CLEO_CH_STANDARD_CULTURE_RIVER', 'DistrictType', 'DISTRICT_COMMERCIAL_HUB'), 
('CCB_CLEO_CH_STANDARD_CULTURE_RIVER', 'YieldType', 'YIELD_CULTURE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_MEDITERRANEAN', 'CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER', 'MODIFIER_PLAYER_CITIES_RIVER_ADJACENCY', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER', 'Amount', '1'), 
('CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER', 'Description', 'LOC_CCB_DISTRICT_RIVER_CULTURE'), 
('CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER', 'DistrictType', 'DISTRICT_THEATER'), 
('CCB_CLEO_THEATRE_STANDARD_CULTURE_RIVER', 'YieldType', 'YIELD_CULTURE');
