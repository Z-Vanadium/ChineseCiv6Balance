...
-- 2026/07/12 独裁传承效果：建筑不再提供全产
DELETE FROM PolicyModifiers
      WHERE PolicyType = 'POLICY_GOV_AUTOCRACY' AND
            ModifierId IN ('AUTOCRACY_TIER1', 'AUTOCRACY_TIER2', 'AUTOCRACY_TIER3', 'CONSULATE_TIER1', 'CHANCERY_TIER2');
