...
-- 09/03/2024 delay faith to early empire
...
INSERT INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, AdjacentImprovement, OtherDistrictAdjacent,PreReqCivic) VALUES
	('BBG_Ziggurat_Faith_Farm', 'Placeholder', 'YIELD_FAITH', 1, 2, 'IMPROVEMENT_FARM', 0,'CIVIC_EARLY_EMPIRE'),
    ('BBG_Ziggurat_Faith_District', 'Placeholder', 'YIELD_FAITH', 1, 1, NULL, 1,'CIVIC_EARLY_EMPIRE');
...
-- +2/+4/+6 bonus influence point from highest alliance level
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_ADVENTURES_ENKIDU', 'CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_1');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_1', 'MODIFIER_PLAYER_ADJUST_INFLUENCE_POINTS_PER_TURN', 0, 0, 0, NULL, 'BBG_PLAYER_IS_ALLY_EXCLUSIVE_LEVEL_1');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_1', 'Amount', '2');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_ADVENTURES_ENKIDU', 'CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_2');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_2', 'MODIFIER_PLAYER_ADJUST_INFLUENCE_POINTS_PER_TURN', 0, 0, 0, NULL, 'BBG_PLAYER_IS_ALLY_EXCLUSIVE_LEVEL_2');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_2', 'Amount', '4');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_LEADER_ADVENTURES_ENKIDU', 'CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_3');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_3', 'MODIFIER_PLAYER_ADJUST_INFLUENCE_POINTS_PER_TURN', 0, 0, 0, NULL, 'BBG_PLAYER_IS_ALLY_EXCLUSIVE_LEVEL_3');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('CCB_SUMER_INFLUENCE_POINT_PER_ALLIANCE_LEVEL_3', 'Amount', '6');
