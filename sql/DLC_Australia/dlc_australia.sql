...
-- 02/07/24 no prod bonus on pasture
-- 30/09/24 production at political
-- 2025/09/18 prod at early empire
INSERT INTO Modifiers(ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_AUSTRALIA_PASTURE_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'BBG_UTILS_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQSET', NULL),
...
--     ('BBG_PLOT_CHARMING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIREMENTSET_TEST_ALL'),
--     ('BBG_PLOT_BREATHTAKING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIREMENTSET_TEST_ALL');
-- INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
--     ('BBG_PLOT_CHARMING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIRES_PLOT_CHARMING_APPEAL'),
--     ('BBG_PLOT_CHARMING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIRES_DISTRICT_IS_CITY_CENTER'),
--     ('BBG_PLOT_CHARMING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'BBG_UTILS_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQUIREMENT'),
--     ('BBG_PLOT_BREATHTAKING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIRES_PLOT_BREATHTAKING_APPEAL'),
--     ('BBG_PLOT_BREATHTAKING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'REQUIRES_DISTRICT_IS_CITY_CENTER'),
--     ('BBG_PLOT_BREATHTAKING_CITY_CENTER_EARLY_EMPIRE_REQSET', 'BBG_UTILS_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQUIREMENT');

-- INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('BBG_AUSTRALIA_AMENITY_CHARMING_EARLY_EMPIRE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_EXTRA_ENTERTAINMENT', 'BBG_PLOT_CHARMING_CITY_CENTER_EARLY_EMPIRE_REQSET'),
--     ('BBG_AUSTRALIA_AMENITY_BREATHTAKING_EARLY_EMPIRE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_EXTRA_ENTERTAINMENT', 'BBG_PLOT_BREATHTAKING_CITY_CENTER_EARLY_EMPIRE_REQSET');
-- INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
--     ('BBG_AUSTRALIA_AMENITY_CHARMING_EARLY_EMPIRE', 'Amount', 1),
--     ('BBG_AUSTRALIA_AMENITY_BREATHTAKING_EARLY_EMPIRE', 'Amount', 1);
-- INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
--     ('TRAIT_CIVILIZATION_LAND_DOWN_UNDER', 'BBG_AUSTRALIA_AMENITY_CHARMING_EARLY_EMPIRE'),
--     ('TRAIT_CIVILIZATION_LAND_DOWN_UNDER', 'BBG_AUSTRALIA_AMENITY_BREATHTAKING_EARLY_EMPIRE');
